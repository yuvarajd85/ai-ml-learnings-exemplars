...
def main():
    ...
    url = f"https://cricclubs.com/PMCL/listMatches.do?league=17&year=2022&clubId=585"
    ...
    df.to_excel(f"C://Users//{str(os.getlogin()).strip()}//Desktop//PMCLF40MOM.xlsx",index=False)
